...
{
	half MinFogOpacity = ExponentialFogColorParameter.w;
	MinFogOpacity = 0.0;
	...
	half ExpFogFactor = max(saturate(exp2(-ExponentialHeightLineIntegralShared)), MinFogOpacity);
	...
	return half4(ExpFogFactor.xxx, 1.0);
}
